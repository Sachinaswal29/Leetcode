<h2> 1635 80
1352. Product of the Last K Numbers</h2><hr><div style="user-select: auto;"><p style="user-select: auto;">Design an algorithm that accepts a stream of integers and retrieves the product of the last <code style="user-select: auto;">k</code> integers of the stream.</p>
...
<p style="user-select: auto;"><strong class="example" style="user-select: auto;">Example:</strong></p>
...
<p style="user-select: auto;">&nbsp;</p>
<strong style="user-select: auto;">Follow-up: </strong>Can you implement <strong style="user-select: auto;">both</strong> <code style="user-select: auto;">GetProduct</code> and <code style="user-select: auto;">Add</code> to work in <code style="user-select: auto;">O(1)</code> time complexity instead of <code style="user-select: auto;">O(k)</code> time complexity?</div>