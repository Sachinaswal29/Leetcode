<h2> 1858 73
1422. Maximum Score After Splitting a String</h2><hr><div style="user-select: auto;"><p style="user-select: auto;">Given a&nbsp;string <code style="user-select: auto;">s</code>&nbsp;of zeros and ones, <em style="user-select: auto;">return the maximum score after splitting the string into two <strong style="user-select: auto;">non-empty</strong> substrings</em> (i.e. <strong style="user-select: auto;">left</strong> substring and <strong style="user-select: auto;">right</strong> substring).</p>
